  ...
  // Attention! javascrip refuse info1, il veut qu'on écrit en toute lettre
	  ...
	  coursUn.onmouseout = function(){infoUn.style.display = "none";}
	  ...
	  coursDeux.onmouseout = function(){infoDeux.style.display = "none";}
	  ...
	  coursTrois.onmouseout = function(){infoTrois.style.display = "none";} 
